...
//define("SMTP_HOST", "tls://smtp.office365.com");
//define("SMTP_PORT", '587');
//define("SMTP_USER", 'helpdesk@experttech.ca');
//define("SMTP_PASS", 'J7688328jgjj!');

if($_SERVER['HTTP_HOST'] == "localhost"){
define("IMAGES", 'http://' . $_SERVER['HTTP_HOST'] . '/helpdesk/public/asset/images/');
}else{
    define("IMAGES", 'https://' . $_SERVER['HTTP_HOST'] . '/helpdesk/public/asset/images/');
}
